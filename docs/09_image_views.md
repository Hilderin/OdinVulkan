...
With image views in hand, the next step is the graphics pipeline — the shaders and fixed-function state that turn "draw a triangle" into actual GPU work. That's [10 — Graphics Pipeline](./10_graphics_pipeline.md).